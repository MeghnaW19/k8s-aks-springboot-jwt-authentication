...
3. Navigate to maincourse_java_jfse_mc05_k8s_AKS_springboot_jwt_authentication_exercise folder

    `cd maincourse_java_jfse_mc05_k8s_AKS_springboot_jwt_authentication_exercise`
